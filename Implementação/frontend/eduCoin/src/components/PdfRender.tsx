        ...
        <Document>
            <Page size="A4" style={styles.page}>
                <View style={{ ...styles.section }}>
                    ...
                    {transactions.map((transaction: any) => <Text style={{ marginBottom: 10 }}> - {transaction.description}{transaction.type !== "benefit" ? " | para " + transaction.name : ''} | {transaction.value} moedas</Text>)}
                </View>
